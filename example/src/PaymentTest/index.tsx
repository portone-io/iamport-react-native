...
type NavigationProp = StackNavigationProp<RootStackParamList, 'PaymentTest'>;
          ...
          <FormControl p={2} borderRadius={3}>
            <VStack>
              ...
              <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                <InputField
                  value={userCode}
                  onChangeText={(value: string) => setUserCode(value)}
                />
              </Input>
            </VStack>
            <VStack>
            ...
            <VStack>
              ...
              <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                <InputField
                  value={tierCode}
                  onChangeText={(value: string) => setTierCode(value)}
                />
              </Input>
            </VStack>
            <VStack>
              ...
              <VStack>
                ...
                <Picker
                  ...
                  onValueChange={(value: string) =>
                    setCardQuota(parseInt(value, 10))
                  }
                />
              </VStack>
            )}
            {method === 'vbank' && (
              <VStack>
                ...
                <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                  <InputField
                    value={vbankDue}
                    onChangeText={(value: string) => setVbankDue(value)}
                  />
                </Input>
              </VStack>
            )}
              ...
              <VStack>
                ...
                <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                  <InputField
                    ...
                    returnKeyType={'done'}
                    value={bizNum}
                    onChangeText={(value: string) => setBizNum(value)}
                  />
                </Input>
              </VStack>
            )}
            {method === 'phone' && (
              <VStack>
                ...
                <Switch
                  ...
                  onValueChange={(value: boolean) => setDigital(value)}
                />
              </VStack>
            )}
            <VStack>
              ...
              <Switch
                ...
                value={escrow}
                alignSelf={'flex-start'}
                onValueChange={(value: boolean) => setEscrow(value)}
              />
            </VStack>
            <VStack>
              <FormControl.Label my={1}>
            ...
            <VStack>
              ...
              <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                <InputField
                  value={merchantUid}
                  onChangeText={(value: string) => setMerchantUid(value)}
                />
              </Input>
            </VStack>
            <VStack>
              ...
              <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                <InputField
                  value={buyerName}
                  onChangeText={(value: string) => setBuyerName(value)}
                />
              </Input>
            </VStack>
            <VStack>
              ...
              <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                <InputField
                  ...
                  returnKeyType={'done'}
                  value={buyerTel}
                  onChangeText={(value: string) => setBuyerTel(value)}
                />
              </Input>
            </VStack>
            <VStack>
              ...
              <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                <InputField
                  value={buyerEmail}
                  onChangeText={(value: string) => setBuyerEmail(value)}
                />
              </Input>
            </VStack>
            <Button
